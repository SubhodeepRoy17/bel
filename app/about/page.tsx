...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#150237] text-white" style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      <section className="relative pt-24 pb-16 md:py-20">
            ...
            <div className="grid grid-cols-1 gap-8 md:gap-12">
              ...
              <div className="relative">
                ...
                <div className="bg-[#2a1a55] p-4 md:p-6 rounded-lg border border-yellow-500/20">
                  <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-4 text-yellow-400">The Beginning</h3>
              ...
              <div className="relative">
                ...
                <div className="bg-[#2a1a55] p-4 md:p-6 rounded-lg border border-yellow-500/20">
                  <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-4 text-yellow-400">First Tournament</h3>
                  <p className="text-sm md:text-base text-gray-200">
              ...
              <div className="relative">
                ...
                <div className="bg-[#2a1a55] p-4 md:p-6 rounded-lg border border-yellow-500/20">
                  <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-4 text-yellow-400">Growth & Recognition</h3>
                  <p className="text-sm md:text-base text-gray-200">
      ...
      {/* Meet the Team - Responsive grid */}
      <section className="py-12 md:py-16 bg-[#1a1145]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4 text-yellow-400">Meet the Team</h2>
            <div className="h-1 w-16 md:w-20 bg-yellow-500 mx-auto mb-4 md:mb-6"></div>
            <p className="text-base md:text-lg max-w-3xl mx-auto text-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <Card className="bg-[#2a1a55] border-yellow-500/20 overflow-hidden">
              ...
              <CardContent className="pt-3 md:pt-4">
                <h3 className="text-lg md:text-xl font-bold mb-1 text-yellow-400">Manoj Kumar Tiwari</h3>
                <p className="text-xs md:text-sm text-yellow-300 mb-2 md:mb-3">Founder & Tournament Director</p>
            ...
            <Card className="bg-[#2a1a55] border-yellow-500/20 overflow-hidden">
              ...
              <CardContent className="pt-3 md:pt-4">
                <h3 className="text-lg md:text-xl font-bold mb-1 text-yellow-400">Lakxmi Ratan Shukla</h3>
                <p className="text-xs md:text-sm text-yellow-300 mb-2 md:mb-3">Operations Manager</p>
                <p className="text-xs md:text-sm text-gray-300">
            ...
            <Card className="bg-[#2a1a55] border-yellow-500/20 overflow-hidden">
              ...
              <CardContent className="pt-3 md:pt-4">
                <h3 className="text-lg md:text-xl font-bold mb-1 text-yellow-400">Sanjay Ghosh</h3>
                <p className="text-xs md:text-sm text-yellow-300 mb-2 md:mb-3">Technical Director</p>
                <p className="text-xs md:text-sm text-gray-300">
            ...
            <Card className="bg-[#2a1a55] border-yellow-500/20 overflow-hidden">
              ...
              <CardContent className="pt-3 md:pt-4">
                <h3 className="text-lg md:text-xl font-bold mb-1 text-yellow-400">Priya Banerjee</h3>
                <p className="text-xs md:text-sm text-yellow-300 mb-2 md:mb-3">Marketing & PR</p>
                <p className="text-xs md:text-sm text-gray-300">
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4 text-yellow-400">What People Say</h2>
            <div className="h-1 w-16 md:w-20 bg-yellow-500 mx-auto mb-4 md:mb-6"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {/* Testimonial 1 */}
            <div className="bg-[#2a1a55] p-4 md:p-6 rounded-lg border border-yellow-500/20 relative">
              <div className="absolute -top-4 md:-top-5 left-4 md:left-6 text-yellow-400 text-4xl md:text-6xl">&quot;</div>
              <p className="text-sm md:text-base text-gray-200 mb-4 md:mb-6 pt-2 md:pt-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-bold text-sm md:text-base text-yellow-400">Arjun Dutta</h4>
                  <p className="text-xs md:text-sm text-gray-300">Former BEL Player</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2a1a55] p-4 md:p-6 rounded-lg border border-yellow-500/20 relative">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-bold text-sm md:text-base text-yellow-400">Debashish Roy</h4>
                  <p className="text-xs md:text-sm text-gray-300">Team Coach</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2a1a55] p-4 md:p-6 rounded-lg border border-yellow-500/20 relative">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-bold text-sm md:text-base text-yellow-400">Ritu Agarwal</h4>
                  <p className="text-xs md:text-sm text-gray-300">Sponsor Representative</p>
                </div>
              </div>
            </div>
          </div>
