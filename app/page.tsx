      ...
      <div className="container mx-auto px-4 z-10 text-center py-20">
        ...
        <div className="relative">
          ...
          <div className="relative mb-12">
            ...
            <h1 className="text-7xl md:text-7xl lg:text-7xl font-medium mb-6 text-yellow-400 tracking-normal drop-shadow-[2px_2px_4px_rgba(220,38,38,0.5)] relative z-10 py-2" style={{ fontFamily: 'Boulevard Saint Denis' }}>
